...
public class ChongwuJiyangController {
    ...
    */
    ...
    public R save(@RequestBody ChongwuJiyangEntity chongwuJiyang, HttpServletRequest request){
        ...
        Wrapper<ChongwuJiyangEntity> queryWrapper = new EntityWrapper<ChongwuJiyangEntity>()
            ...
            .eq("chongwu_jiyang_name", chongwuJiyang.getChongwuJiyangName())
            .eq("chongwu_types", chongwuJiyang.getChongwuTypes())
            .eq("chongwu_sex_types", chongwuJiyang.getChongwuSexTypes())
            .eq("chongwu_jiyang_age", chongwuJiyang.getChongwuJiyangAge())
            .eq("chongwu_jiyang_huase", chongwuJiyang.getChongwuJiyangHuase())
            .eq("chongwu_jiankang_types", chongwuJiyang.getChongwuJiankangTypes())
            .eq("chongwu_jiyang_suozaidi", chongwuJiyang.getChongwuJiyangSuozaidi())
            .eq("chongwu_jiyang_number", chongwuJiyang.getChongwuJiyangNumber())
            .eq("chongwu_jiyang_types", chongwuJiyang.getChongwuJiyangTypes())
            ;
    ...
    */
    ...
    ChongwuJiyangEntity chongwuJiyangEntity = chongwuJiyangService.selectOne(queryWrapper);
        ...
        //      chongwuJiyang.set
        //  }
            chongwuJiyang.setChongwuJiyangTypes(2);//未接收
